...
import bisnis.com.official.Activity_Detail;
 ...
 */
public class Fragmented_saved extends Fragment{
     ...
     * number.
     */
    public static Fragmented_saved newInstance(int sectionNumber) {

        Fragmented_saved fragment = new Fragmented_saved();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Table_List_Nav get_save = new Table_List_Nav(getActivity(),null,null,0);
        ArrayList <Frame_nav> data_save = get_save.get_all_nav_cek();
        String canal_id [] = new String[data_save.size()];
        String canal_name [] = new String[data_save.size()];
        for (int i =0 ; i <data_save.size(); i++ ){
        canal_id [i] = data_save.get(i).id;
        canal_name [i]= data_save.get(i).nav;
        }
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override public void run() {
                        ...
                        if(canal.length()<4&(!canal.equals("cari"))){
                            ...
                            get_data(con.URL+"headlines/1/"+canal+"/1");
