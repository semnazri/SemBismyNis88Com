...
import bisnis.com.official.home.Adapter_List_Berita_Rec.OnItemClickListener;

/**
 * Created by sibertama on 1/27/15.
 */
public class Fragmented_Home extends Fragment{
     ...
     * number.
     */
    public static Fragmented_Home newInstance(int sectionNumber) {

        Fragmented_Home fragment = new Fragmented_Home();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String canal_id [] = getActivity().getResources().getStringArray(R.array.array_frontpage_id);
        String canal_name [] = getActivity().getResources().getStringArray(R.array.array_frontpage);
        ...
        System.out.print("ADS H OME" + canal + "\n");
        adapter_list_berita.addCanalId(getArguments().getInt(CANAL_ID));
...
//                            adapter_list_berita.add(new Frame_ListBerita(obj.getString("post_id"),obj.getString("category_id"),obj2.getString("year")+obj2.getString("month")+obj2.getString("day"), obj.getString("image_uri")+"?w=600", obj2.getString("day")+"/"+obj2.getString("month")+"/"+obj2.getString("year")," - "+obj2.getString("hour")+":"+obj2.getString("minute")+" WIB", obj.getString("title"),""+canal,obj.getString("parent_category"),obj.getString("slug"),obj.getString("is_live").obj.getString("subtitle")));
                            adapter_list_berita.add(new Frame_ListBerita(obj.getString("post_id"),obj.getString("category_id"),obj2.getString("year")+obj2.getString("month")+obj2.getString("day"), obj.getString("image_uri")+"?w=600", obj2.getString("day")+"/"+obj2.getString("month")+"/"+obj2.getString("year")," - "+obj2.getString("hour")+":"+obj2.getString("minute")+" WIB", obj.getString("title"),""+canal,obj.getString("parent_category"),obj.getString("slug"),obj.getString("is_live"), obj.getString("subtitle")));
                            Log.d("aaa", obj.getString("subtitle"));
                        }
                        mulai=mulai+10;
                        much = much+10;
                    ...
                    if (adapter_list_berita != null) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonarray.length(); i++) {
                                JSONObject obj = jsonarray.getJSONObject(i);
                                JSONObject obj2 = obj.getJSONObject("date");
                                Log.d("split ", obj.getString("category_link"));
                                String[] split = obj.getString("category_link").split("-");
                                ...
                                System.out.println("tabbgal baru : " + tgl_terakhir_flag);
                                //array_list_berita.add(new Frame_ListBerita(obj.getString("post_id"),obj.getString("category_id"),obj2.getString("year")+obj2.getString("month")+obj2.getString("day"), obj.getString("image_uri")+"?w=300", obj2.getString("day")+"/"+obj2.getString("month")+"/"+obj2.getString("year"),obj2.getString("hour")+":"+obj2.getString("minute")+" WIB", obj.getString("title"),obj.getString("image_content"),obj.getString("parent_category")+" - "+sub_canal,obj.getString("slug"),obj.getString("is_live")));
                                adapter_list_berita.add(new Frame_ListBerita(obj.getString("post_id"), obj.getString("category_id"), obj2.getString("year") + obj2.getString("month") + obj2.getString("day"), obj.getString("image_uri") + "?w=600", obj2.getString("day") + "/" + obj2.getString("month") + "/" + obj2.getString("year"), " - " + obj2.getString("hour") + ":" + obj2.getString("minute") + " WIB", obj.getString("title"), "" + canal, obj.getString("parent_category"), obj.getString("slug"), obj.getString("is_live"), obj.getString("subtitle")));
                                Log.d("aaa", obj.getString("parent_category"));
                            }
