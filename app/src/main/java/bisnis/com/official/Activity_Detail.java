...
public class Activity_Detail extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter_list_terkait = new Adapter_List_Terkait(Activity_Detail.this, R.layout.list_terkait, array_list_terkait);
...
//                        .commit();
    ...
    private class MainAdapter3 extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            array_list_terkait.clear();

            View rootView = new View(Activity_Detail.this.getApplicationContext());
            final LayoutInflater inflater = (LayoutInflater) Activity_Detail.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            rootView = inflater.inflate(R.layout.fragment_detail, container, false);


            Table_Setting db = new Table_Setting(Activity_Detail.this, null, null, 0);
            ...
            if (data.get(position).getLive().equals("0")) {
                ...
                Log.d("title", data.get(position).getJudulberita());
            } else {
                txtjudul.setText("     " + data.get(position).getJudulberita());
            }
            ...
            list_terkait.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0, View arg1,
                    ...
                    intent.setClass(Activity_Detail.this, Activity_Detail_Terkait.class);
            ...
            imgcomment.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    if (!(porses2.isShown())) {
                        Dialog dialog = new Dialog(Activity_Detail.this);
            ...
            imgsave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    // TODO Auto-generated method stub
                    Table_ListBerita db = new Table_ListBerita(Activity_Detail.this, null, null, 0);
                    db.addBerita(data_save);
                    db.close();
                    Toast.makeText(Activity_Detail.this, "Berita Sudah Di Bookmarks", Toast.LENGTH_LONG).show();
                }
            });
