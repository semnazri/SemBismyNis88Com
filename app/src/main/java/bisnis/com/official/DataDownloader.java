...
ProgressBar dataload;
	...
	public DataDownloader(Adapter_List_Berita_Rec list_data, ProgressBar porses) {
	...
	protected void onPostExecute(String result){	
		...
		int count_tgl=1;
		 if (isCancelled()) {
             ...
             dataload.setContentDescription(tgl_terakhir_flag + "@" + count_tgl);
