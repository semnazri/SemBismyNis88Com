...
public class Adapter_List_Berita extends ArrayAdapter<Frame_ListBerita>{
	...
	public Adapter_List_Berita(Context context, int layoutResourceId,ArrayList<Frame_ListBerita> objects) {
...
//						}
	...
	public View getView(int position, View convertView, ViewGroup parent){
        ...
        holder.txtjudul2.setTypeface(open_sans,Typeface.BOLD);
