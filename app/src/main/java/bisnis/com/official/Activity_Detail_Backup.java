...
import bisnis.com.official.R.id;
...
public class Activity_Detail_Backup extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNavigationDrawerFragment = (NavigationDrawerFragment3) getSupportFragmentManager().findFragmentById(id.navigation_drawer);
        mTitle = getTitle();

        // Set up the drawer.
        mNavigationDrawerFragment.setUp(
                id.navigation_drawer,
                (FullDrawerLayout) findViewById(id.drawer_layout));
        ...
        proses = (ProgressBar) findViewById(id.prosesdata);
...
//                        .commit();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case id.action_search:
                ...
                final EditText txtcari = (EditText) layout.findViewById(id.txtcari);
    ...
    private void setRefreshActionButtonState(boolean refresing) {
        // TODO Auto-generated method stub
        if (optionsMenu != null) {
            final MenuItem refreshItem = optionsMenu.findItem(id.action_refresh);
            if (refreshItem != null) {
                if (refresing) {
                    //error api 8
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        TextView txtjudul, txtdate2, txtpenulis, txtimg_caption, txteditor, txtimg_sumber, txt_oldest, txt_lastest, txt_subtitle;
        ...
        public static PlaceholderFragment newInstance(int sectionNumber, Frame_ListBerita frame_ListBerita, int SIZE) {
            ...
            args.putString("SUBTITLE", frame_ListBerita.getSubtitle());
            save_position = sectionNumber;
            //data_save=frame_ListBerita;
            args.putInt("MAX_PAGE", SIZE);
            fragment.setArguments(args);
            // data_series=new Frame_ListBerita(frame_ListBerita.getIdberita(), frame_ListBerita.getCategory(), frame_ListBerita.getDatepost(), "", "", "", frame_ListBerita.getJudulberita(), "", "", "", frame_ListBerita.getLive());
            return fragment;
        }
        ...
        public View onCreateView(LayoutInflater inflater, final ViewGroup container,
            ...
            porses2 = (ProgressBar) rootView.findViewById(id.prosesdata);
            porses2.setVisibility(View.VISIBLE);
            //  File image2 = null ;

            final RelativeLayout laytout_share = (RelativeLayout) rootView.findViewById(id.layout_share);
            txtdate = (TextView) rootView.findViewById(id.txttgl);
            txtnext = (TextView) rootView.findViewById(id.txtnext);
            txtprevious = (TextView) rootView.findViewById(id.txtprevious);

            txtjudul = (TextView) rootView.findViewById(id.txt_detail_judul);
            txtjudul.requestFocus();
            txt_subtitle = (TextView) rootView.findViewById(id.subtitle);
            layout_subs = (LinearLayout) rootView.findViewById(id.subtitle_layuot);
            txtdate2 = (TextView) rootView.findViewById(id.txtdate);
            txtimg_caption = (TextView) rootView.findViewById(id.txtimg_caption);
            txtpenulis = (TextView) rootView.findViewById(id.txt_detail_penulis);
            txteditor = (TextView) rootView.findViewById(id.txteditor);
            imgberita = (ImageView) rootView.findViewById(id.imgfitured);
            webdetail = (WebView) rootView.findViewById(id.webdetail);
            web_live = (WebView) rootView.findViewById(id.web_live);
            txtimg_sumber = (TextView) rootView.findViewById(id.txtimg_sumber);
            list_terkait = (CustomExpandListView) rootView.findViewById(id.list_terkait);
            table_live = (TableRow) rootView.findViewById(id.table_live);
            cmd_lastest = (TableRow) rootView.findViewById(id.cmd_latest);
            cmd_olderst = (TableRow) rootView.findViewById(id.cmd_older);
            img_live_detail = (ImageView) rootView.findViewById(id.img_live_detail);
            table_live = (TableRow) rootView.findViewById(id.table_live);
            txt_lastest = (TextView) rootView.findViewById(id.txt_lastest);
            txt_oldest = (TextView) rootView.findViewById(id.txt_older);

            //series
            table_series = (TableRow) rootView.findViewById(id.tableRowSeries);
            table_series_bottom = (TableRow) rootView.findViewById(id.tableRowSeriesbottom);
            txtjuduldetailseries = (TextView) rootView.findViewById(id.txtjuduldetailseries);
            txtseries = (TextView) rootView.findViewById(id.txtseries);
            txtseriesbottom = (TextView) rootView.findViewById(id.txtseriesbottom);
            txtnextseries = (TextView) rootView.findViewById(id.txtnextseries);
            txtpreviousseries = (TextView) rootView.findViewById(id.txtpreviousseries);
            txtnextseriesbottom = (TextView) rootView.findViewById(id.txtnextseriesbottom);
            txtpreviousseriesbottom = (TextView) rootView.findViewById(id.txtpreviousseriesbottom);
            //end series
...
//            Log.d("subtitle", getArguments().getString("SUBTITLE"));

            if (getArguments().getString("SUBTITLE").equals("")){
                layout_subs.setVisibility(View.GONE);
            }
            ...
            if (getArguments().getString("IS_LIVE").equals("0")) {
                ...
                txt_subtitle.setText(getArguments().getString("SUBTITLE"));
            ...
            final ScrollView scrollbertia = (ScrollView) rootView.findViewById(id.scrolldetailberita);

            final ImageView imgshare = (ImageView) rootView.findViewById(id.imgshare);
            final ImageView imgsave = (ImageView) rootView.findViewById(id.imgsave);
            final ImageView imgcomment = (ImageView) rootView.findViewById(id.imgcomment);

            txtdate.setText(dateFormat.format(date));

            txtpage = (TextView) rootView.findViewById(id.txt_page);
            ...
            imgcomment.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    if (!(porses2.isShown())) {
                        ...
                        WebView web_comment = (WebView) dialog.findViewById(id.web_comment);
                  /*  AlertDialog.Builder imageDialog = new AlertDialog.Builder(getActivity());
            ...
            WebView web_iklan = (WebView) rootView.findViewById(id.web_iklan);
        ...
        public void onAttach(Activity activity) {
            ...
            //  ((Activity_Detail_Backup) activity).onSectionAttached(CANAL_ID);
        }
    }
