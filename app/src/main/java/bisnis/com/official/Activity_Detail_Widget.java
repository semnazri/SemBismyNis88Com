...
public class Activity_Detail_Widget extends ActionBarActivity
	...
	public ArrayList<Frame_ListBerita> data = new ArrayList<Frame_ListBerita>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int CANAL_ID=act_param.getInt("DATA");
...
//		}
        ...
        data.addAll(Singelton_List_Berita.getInstance().getArray_widget());
       ...
       for (int i = 0; i < data.size(); i++) {
			if(data.get(i).getIdberita().equals(""+CANAL_ID)){
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onResume() {
	        ...
	        if(font_size!=db.get_setting_font_size()||refresh_interfal!=db.get_setting_refresh()){
	            ...
	            txtjudul.setTextSize(size_font+2);
            ...
            String css= "<style> .detail{ font-size:"+(size_font+2)+"px; } img{width:100%;} p{line-height:28px;} </style>";
		       ...
		       list_terkait.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					intent.setClass(getActivity(), Activity_Detail_Widget_Terkait.class);
    ...
    // webSettings2.setJavaScriptEnabled(true);
     ...
     return rootView;
        ...
        public void onAttach(Activity activity) {
            ...
            ((Activity_Detail_Widget) activity).onSectionAttached(CANAL_ID);
        }
    }
    @Override
